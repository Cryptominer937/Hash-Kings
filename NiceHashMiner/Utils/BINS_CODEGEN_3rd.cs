...
@"\optiminer_zcash_win\bin\round1.bin",

@"\optiminer_zcash_win\bin\round2.bin",

@"\optiminer_zcash_win\bin\round3.bin",

@"\optiminer_zcash_win\bin\round4.bin",

@"\optiminer_zcash_win\bin\round5.bin",

@"\optiminer_zcash_win\bin\round6.bin",
